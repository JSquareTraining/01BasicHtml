...
It is a simple Create Account (Signup) Form built using only HTML.
...
The purpose of this project is to understand how basic webpage structure and form design work using pure HTML.
...
Background color using bgcolor

Text formatting using <font>
...
This project includes a complete beginner-level form design structure:
...
It represents a fully structured beginner-level webpage using only basic HTML elements.
...
| `<font>`  | Styles text color and size (basic method)                           |
| `<h1>`    | Main heading                                                        |
| `<h2>`    | Subheading                                                          |
...
| `<br>`    | Adds spacing using line breaks                                      |

🚀 How to Add and Run the HTML Page Using Visual Studio
